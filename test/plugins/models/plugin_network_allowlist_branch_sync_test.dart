...
void main() {
  test(
    'כל כתובת ברשימה המקומפלת מופיעה גם בקובץ שבענף הייעודי ב-GitHub',
    () async {
      final response = await http.get(
        PluginNetworkAccessResolver.officialAllowlistUri,
      );
      expect(
        response.statusCode,
        200,
      ...
      final branchAllowlist = parsePluginNetworkAllowlistText(
      ...
      expect(
        ...
        isEmpty,
        reason:
            'כתובות שקיימות ברשימה המקומפלת אך חסרות בקובץ '
