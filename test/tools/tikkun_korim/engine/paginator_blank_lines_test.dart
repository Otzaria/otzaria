...
/// כמה מילים בנות שלוש אותיות ממלאות שיטה — נגזר מהתקציב ולא מקובע, כדי
/// שהבדיקה תמשיך לבחון שיטה מלאה גם כשרוחב הטור משתנה.
final int _wordsPerLine =
    (_widths.lineWidthEm / (_widths.wordWidthEm('אבג') + _widths.wordGapEm))
        .floor();
...
void main() {
  test('מעבר חומש — בדיוק ד" שיטין פנויות', () {
    for (final wordsBefore in [3, _wordsPerLine]) {
