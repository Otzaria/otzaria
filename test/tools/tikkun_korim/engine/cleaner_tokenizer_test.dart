...
void main() {
  group('cleanRawText', () {
    ...
    test('חולם חסר לוי"ו מנורמל לחולם', () {
      expect(cleanRawText('בַּעֲוֺנֶךָ'), 'בַּעֲוֹנֶךָ');
    });
    ...
    test('סימוני פרשיות נשמרים, והמקף שובר תיבה ונשאר בסופה', () {
      expect(cleanRawText('שלום {פ} על־עולם'), 'שלום {פ} על־ עולם');
      // הסת"ם אינו יודע מקף: stripNikud מסיר אותו עם שאר הסימנים.
      expect(stripNikud('על־'), 'על');
    });
  });
