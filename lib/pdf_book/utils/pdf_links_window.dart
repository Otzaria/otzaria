...
class PdfLinksWindowPolicy {
  ...
  /// כמה שורות טקסט נטענות מעבר לטווח הנוכחי לכל כיוון. ערך נדיב —
  /// שקול לעשרות עמודי PDF, אך עדיין זעיר לעומת כל קישורי ספר גדול.
  static const int marginLines = 1500;

  /// מרחק ההתראה מקצה החלון: כשהטווח הנוכחי מתקרב לקצה עד כדי ערך זה,
  /// נטען חלון חדש ברקע עוד לפני שהמשתמש חוצה אותו.
  static const int slackLines = 300;
