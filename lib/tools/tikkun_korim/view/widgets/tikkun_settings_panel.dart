...
const List<AppMenuEntry<String>> _kStamFontEntries = [
  AppMenuEntry(value: 'Ashurit', label: 'אשורית'),
  AppMenuEntry(value: 'Ashkenazi', label: 'אשכנזי (בית יוסף)'),
  AppMenuEntry(value: 'Sefardi', label: 'ספרדי (וועליש)'),
  ..._kOtzariaFontEntries,
];

List<AppMenuEntry<String>> tikkunStamFontEntries() => _kStamFontEntries;

/// גופני הסת"ם של Culmus אינם מוצעים כאן: אין בהם מִתאר לניקוד ולטעמים.
const List<AppMenuEntry<String>> _kNikudFontEntries = [
  AppMenuEntry(value: 'AshuritNikud', label: 'אשורית'),
  ..._kOtzariaFontEntries,
];

List<AppMenuEntry<String>> tikkunNikudFontEntries() => _kNikudFontEntries;
        ...
        SettingsCard(
          ...
          children: [
            SettingsActionTile.dropdownTile<String>(
              ...
              onSelected: (value) =>
                  _emit(settings.copyWith(stamFont: value ?? 'Ashurit')),
            ),
            SettingsActionTile.dropdownTile<String>(
              icon: FluentIcons.text_font_24_regular,
              title: 'גופן ניקוד',
              ...
              onSelected: (value) =>
                  _emit(settings.copyWith(nikudFont: value ?? 'AshuritNikud')),
            ),
            _SliderTile(
              icon: FluentIcons.line_horizontal_3_24_regular,
              title: 'מרווח בין שורות',
              value: settings.lineSpacing,
              min: kTikkunMinLineSpacing,
              max: kTikkunMaxLineSpacing,
              divisions: 15,
