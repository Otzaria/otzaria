...
TikkunLineFit fitTikkunLine({
  ...
  // מתיחת אותיות היא מלאכת הסת"ם; הטור המנוקד רק מתכווץ כשאינו נכנס.
  if (!isStam) return TikkunLineFit.none;
  ...
  for (var i = 0; i < words.length; i++) {
    ...
    widgets.add(
      isStam
          ...
          : NikudWord(text: shown, style: style, condense: fit.condense),
    );
  }
  return widgets;
}
