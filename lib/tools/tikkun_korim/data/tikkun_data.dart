...
import 'package:otzaria/tools/tikkun_korim/data/torah_page_anchors.g.dart';
...
class TikkunData {
  ...
  static final Map<String, List<TikkunWordRef?>> _anchors = {};

  /// עוגן כל עמוד בשיטה [methodId], מחושב מראש מול הטקסט; ריק לשיטה בלי טבלה.
  static List<TikkunWordRef?> torahPageAnchors(String methodId) =>
      _anchors.putIfAbsent(methodId, () {
        final flat = kTorahPageAnchors[methodId];
