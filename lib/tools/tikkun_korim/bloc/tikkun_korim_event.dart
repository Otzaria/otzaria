...
/// שמירת המיקום הנוכחי כסימניה.
class TikkunBookmarkAdded extends TikkunKorimEvent {
  const TikkunBookmarkAdded();
}

class TikkunBookmarkRemoved extends TikkunKorimEvent {
  final String id;
  const TikkunBookmarkRemoved(this.id);

  @override
  List<Object?> get props => [id];
}

class TikkunBookmarkOpened extends TikkunKorimEvent {
  final TikkunBookmark bookmark;
  const TikkunBookmarkOpened(this.bookmark);
