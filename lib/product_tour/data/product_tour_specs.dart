...
const List<TourStepSpec> kIntroTourSteps = [
  TourStepSpec(
    ...
    tip:
        'אם אינך בטוח בניסוח המדויק, התחל בשם הספר ואז הוסף סימן או פרק. האיתור מציע תוצאות תוך כדי הקלדה.',
  ),
  TourStepSpec(
    id: 'full-search',
    ...
    tip:
        'כדאי לעבור לכאן כשמחפשים רעיון או ניסוח ולא מקור נקודתי. כך אפשר להרחיב או לצמצם את התוצאות לפי סוג החיפוש.',
  ),
  TourStepSpec(
    ...
    tip:
        'אם אתה משווה בין טקסט למפרשים, נסה לעבור בין תצוגה בצד לתצוגה מתחת עד שתמצא את צורת העבודה הנוחה לך.',
  ),
];
