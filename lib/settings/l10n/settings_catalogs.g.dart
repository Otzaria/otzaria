...
const Map<String, Map<String, String>> kSettingsCatalogs = {
  'en': {
    ...
    'בדיקת העדכונים הבאה תחפש גם גרסאות בדיקה — ייתכנו באגים':
        'The next update check will also look for test builds — expect bugs',
    'בדיקת העדכונים הבאה תחפש גרסאות יציבות בלבד':
        'The next update check will look for stable builds only',
    'בהיר': 'Light',
    ...
    'במכשיר זה אי אפשר להריץ את סקריפט השליחה. יורד קובץ עבור מחשב Windows מחובר — העבירו אליו את הקובץ והפעילו אותו שם.':
        'This device cannot run the send script. A file for an online Windows computer is downloading — move it there and run it.',
    'במצב אופליין לא יתבצע תור אוטומטי לדיווחים ישירים':
        'Offline, direct reports are not queued automatically',
    ...
    'גיבוי אוטומטי מושבת. הגיבוי האחרון נוצר ב{date}.':
        'Automatic backup is off. The last backup was made on {date}.',
    ...
    'הגיבוי מתבצע כל יום.': 'A backup runs every day.',
    'הדגשת הגופן (בולד)': 'Bold the font',
    'הדיווח יעבור להיסטוריית הדיווחים שנשלחו ויוסר מהתור, ללא שליחה לשרת. השתמשו בכך אם כבר שלחתם את הדיווח בדרך אחרת.':
        'The report moves to the sent history and leaves the queue, without going to the server. Use this if you already sent it another way.',
    ...
    'היסטוריה': 'History',
    'היסטוריית הלימוד': 'Your learning history',
    ...
    'העדכון מתבצע כל {unit}, ואינו מעודכן לשינויים האחרונים - לא קרו הרבה שינויים.':
        'It runs every {unit} and is not fully current — not much has changed.',
    ...
    'הפעולה לא מוחקת דיווחים שכבר נשלחו לצוות.':
        'This does not delete reports the team already received.',
    'הפעל': 'Enable',
    'הפעל סיור מודרך להדרכה והכרת כל מסכי אוצריא':
        'Run a guided tour through all the Otzaria screens',
    ...
    'התוכנה יכולה להתחבר לרשת': 'The app can reach the network',
    'התוכנה מנותקת לגמרי מהרשת': 'The app is fully cut off from the network',
    ...
    'התוספים שהותקנו, הגדרותיהם ונתוניהם':
        'Installed plugins, their settings and their data',
    ...
    'יתבצע גיבוי כל שבוע': 'A backup runs every week',
    'כבוי': 'Off',
    'כהה': 'Dark',
    'כולל את כלל הגדרות התוכנה': 'All of the app\'s settings',
    'כחול': 'Blue',
    'כחול כהה': 'Navy',
    'כל אות מחושבת לפי ספרה אחת': 'Each letter counts as a single digit',
    'כל הדיווחים השמורים בתור יימחקו מהמחשב.':
        'Every report waiting in the queue is deleted from this computer.',
    'כל הדיווחים שנשלחו יימחקו מההיסטוריה המקומית.':
        'Every sent report is deleted from the local history.',
    'כל ההגדרות האישיות שלך ימחקו.':
        'Every setting you personalized will be deleted.',
    ...
    'מסד הנתונים של הספרייה יתעדכן אוטומטית בטעינת הספרייה':
        'The library database updates on its own when the library loads',
    ...
    'נעילת הגדרות וסייר הקבצים, יש להגדיר סיסמה תחילה':
        'Lock the settings and file browser — set a password first',
    'נעילת ההגדרות וסייר הקבצים מושבתת':
        'Settings and the file browser are unlocked',
    'נעילת ההגדרות וסייר הקבצים פעילה':
        'Settings and the file browser are locked',
    'נקה': 'Clear',
    'נקה את כל ההיסטוריה': 'Clear the whole history',
    ...
    'סיור מודרך להכרת התוכנה': 'Guided tour of the app',
    ...
    'סינכרון הספרייה לא יופעל אוטומטית, אך עדיין אפשר להפעיל סינכרון ידני':
        'The library will not sync on its own, but you can still sync it by hand',
    ...
    'עדכוני מערכת של התוכנה והספרים מושבתים': 'App and seforim updates are off',
    'עדכוני תוכנה וספרים': 'App and seforim updates',
    'עדכוני תוכנה וספרים פעילים': 'App and seforim updates are on',
    'עדכן': 'Update',
    ...
    'פעולה זו תחליף את הנתונים הקיימים בנתונים מקובץ הגיבוי העדכני ביותר שנמצא בתיקיית הגיבוי.':
        'This replaces your current data with the newest backup file in the backup folder.',
    ...
    'שבוע מלא, חודשיים שבועי, שנה חודשי — הישן ממוזג לארכיון':
        'A full week, then weekly for two months, then monthly for a year — older ones merge into the archive',
    'שבועי': 'Weekly',
    ...
    'שחזור חלקי — חסרים בקובץ הגיבוי: {items}.\nהאפליקציה תיטען מחדש כעת.':
        'Partial restore — missing from the backup file: {items}.\nThe app will reload now.',
    ...
    'שליחה ישירה לצוות אוצריא, כולל תור אוטומטי במצב אופליין.':
        'Sent straight to the Otzaria team, with an automatic queue when offline.',
    'שם הספר': 'Sefer name',
    ...
    'שמירה מצומצמת — גיבויים ישנים ממוזגים לארכיון מוקדם':
        'Lean — old backups merge into the archive early',
