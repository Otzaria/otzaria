...
2. לפצל תיקיות Core/UI
3. לבנות Registry חדש
4. לבנות Conflict Engine לפני שינוי ה-UI
5. לשכתב את מסך ההגדרות והדיאלוג
6. להעביר את הגלובליים ל-`Shortcuts/Actions`
7. להעביר את המסכים המקומיים ל-wrapper אחיד
8. להוסיף tests
